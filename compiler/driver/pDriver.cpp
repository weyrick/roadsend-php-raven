...
// execute the llvm Module contained in the given pSourceModule
// ir should already have been generated
bool pDriver::executeModule(pSourceModule* pMod) {
/*
    ...
    // EE now owns MP and M, so tell pSourceModule not to delete
