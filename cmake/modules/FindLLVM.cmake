...
if (LLVM_INCLUDE_DIR)
  ...
  exec_program(${LLVM_CONFIG_EXECUTABLE} ARGS --libs core bitreader bitwriter OUTPUT_VARIABLE LLVM_LIBS_CORE )
  ...
  #MESSAGE(STATUS "LLVM native libs: " ${LLVM_LIBS_NATIVE})
  #MESSAGE(STATUS "LLVM native objs: " ${LLVM_LIBS_NATIVE_OBJECTS})
  FIND_LLVM_LIBS( ${LLVM_CONFIG_EXECUTABLE} interpreter LLVM_LIBS_INTERPRETER LLVM_LIBS_INTERPRETER_OBJECTS )
  #MESSAGE(STATUS "LLVM interpreter libs: " ${LLVM_LIBS_INTERPRETER})
  #MESSAGE(STATUS "LLVM interpreter objs: " ${LLVM_LIBS_INTERPRETER_OBJECTS})
